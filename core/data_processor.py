...
class DataLoader():
    ...
    def normalise_windows(self, window_data, single_window=False):
        ...
        To combat this we will take each n-sized window of training/testing data and normalize each one to reflect 
        percentage changes from the start of that window (so the data at point i=0 will always be 0).
        '''
        normalised_data = []
